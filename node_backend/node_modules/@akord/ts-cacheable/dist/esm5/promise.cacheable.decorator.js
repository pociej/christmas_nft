...
var getResponse = function (oldMethod, cacheKey, cacheConfig, context, cachePairs, parameters, pendingCachePairs, storageStrategy) {
    ...
    return function (_target, _propertyKey, propertyDescriptor) {
        ...
        if (propertyDescriptor && propertyDescriptor.value) {
            ...
            propertyDescriptor.value = function () {
                ...
                return cachePairs.then(function (cachePairs) { return getResponse(oldMethod, cacheKey, cacheConfig, _this, cachePairs, parameters, pendingCachePairs_1, storageStrategy_1); });
            };
        }
