...
const getResponse = (oldMethod, cacheKey, cacheConfig, context, cachePairs, parameters, pendingCachePairs, storageStrategy) => {
    ...
    return function (_target, _propertyKey, propertyDescriptor) {
        ...
        if (propertyDescriptor && propertyDescriptor.value) {
            ...
            propertyDescriptor.value = function (...parameters) {
                ...
                return cachePairs.then(cachePairs => getResponse(oldMethod, cacheKey, cacheConfig, this, cachePairs, parameters, pendingCachePairs, storageStrategy));
            };
        }
