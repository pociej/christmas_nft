...
const IStorageStrategy_1 = require("./IStorageStrategy");
const _1 = require(".");
class LocalStorageStrategy extends IStorageStrategy_1.IStorageStrategy {
    constructor() {
        super();
        this.masterCacheKey = _1.GlobalCacheConfig.globalCacheKey;
