...
export declare enum actionRefs {
...
export declare const AKORD_TAG = "Akord-Tag";
export declare enum protocolTags {
...
export declare enum dataTags {
    DATA_TYPE = "Data-Type",
    CONTENT_TYPE = "Content-Type",
    SIGNER_ADDRESS = "Signer-Address",
    SIGNATURE = "Signature"
}
export declare enum fileTags {
    FILE_NAME = "File-Name",
...
export declare enum encryptionTags {
...
export declare enum smartweaveValues {
